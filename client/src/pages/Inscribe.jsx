  ...
  return (
    <div className="px-8 pt-5">
      ...
      <form action="/api/applicant" method="post" enctype="multipart/form-data" className="flex flex-col justify-s w-full space-y-2 font- text-sm text-slate-600">
        ...
        <div className="flex flex-row w-full">
          <label htmlFor="name" className="w-1/5">Teléfono</label>
        ...
        <div className="flex flex-row w-full">
          ...
          <input id="birth_date" type="date" name="fecha" className="w-1/2 border px-1 rounded-sm px-2 py-1 placeholder:ml-5 hover:border-gray-400" />
        </div>
        <div className="flex flex-row w-full">
